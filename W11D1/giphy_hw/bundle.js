...
document.addEventListener('DOMContentLoaded', function () {
  window.fetchSearchGiphys = _util_api_util__WEBPACK_IMPORTED_MODULE_4__["fetchSearchGiphys"]; // const store = configureStore();
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=PAfgjyLsJCrbXQnzygt6jACR7jRUyqJz&limit=2")
  });
